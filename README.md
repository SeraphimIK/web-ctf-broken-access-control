...
- `WALKTHROUGH.md` — full writeup: finding, flag, root cause, and remediation for each challenge
...
This app only listens on `127.0.0.1` and was never exposed to the public internet. It contains no real user data — all names, emails, and notes are fictional placeholders.

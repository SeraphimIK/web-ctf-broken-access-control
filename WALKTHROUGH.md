# CTF Challenge Walkthrough and Remediation

Analyst: Seraphim Ikuomola

## Challenge 1 and 2: Broken Access Control via Hidden Page
...
Root cause: The app relies on security through obscurity, assuming a page is safe because it isn't linked anywhere, instead of an actual authentication and authorization check.
